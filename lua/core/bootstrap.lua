...
exports.lazy = function(install_path)
	------------- base46 ---------------
	local lazy_path = fn.stdpath 'data' .. '/lazy/base46'

	exports.echo '  Compiling base46 theme to bytecode ...'
	...
	--------- lazy.nvim ---------------
	exports.echo '  Installing lazy.nvim & plugins ...'
...
exports.gen_chadrc_template = function()
	local path = fn.stdpath 'config' .. '/lua/custom'

	if fn.isdirectory(path) ~= 1 then
		local input = vim.env.NVCHAD_EXAMPLE_CONFIG
			or fn.input 'Do you want to install example custom config? (y/N): '

		if input:lower() == 'y' then
			exports.echo 'Cloning example custom config repo...'
